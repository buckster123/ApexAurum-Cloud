...
from app.cerebro.models.memory import MemoryNode, StrengthState
from app.cerebro.activation.strength import base_level_activation, retrievability
from app.cerebro.types import MemoryLayer


def compute_current_retrievability(strength: StrengthState, current_time: Optional[float] = None) -> float:
...
def compute_current_activation(strength: StrengthState, current_time: Optional[float] = None) -> float:
...
def check_promotion_eligibility(node: MemoryNode) -> tuple[bool, Optional[str]]:
...
def apply_decay_tick(strength: StrengthState, current_time: Optional[float] = None) -> StrengthState:
