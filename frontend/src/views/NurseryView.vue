...
<template>
  <div class="min-h-screen bg-apex-dark text-white pt-20 px-4">
    <div class="max-w-6xl mx-auto">
      ...
      <!-- ================================================================= -->
      <!-- Tab 2: Training Forge (placeholder)                                -->
      <!-- ================================================================= -->
      <div v-if="activeTab === 'forge'" class="text-center py-20">
        <div class="text-4xl text-gray-600 mb-4">{ }</div>
        <h2 class="text-xl font-bold mb-2 text-gray-300">Training Forge</h2>
        <p class="text-gray-500 max-w-md mx-auto">
          Coming soon -- Cloud GPU training with Together.ai, Vast.ai, RunPod
        </p>
      </div>
      ...
      <!-- ================================================================= -->
      <div v-if="activeTab === 'apprentices'" class="text-center py-20">
        <div class="text-4xl text-gray-600 mb-4">{ }</div>
        <h2 class="text-xl font-bold mb-2 text-gray-300">Apprentices</h2>
        <p class="text-gray-500 max-w-md mx-auto">
          Coming soon -- Agent-raised models trained on Village knowledge
        </p>
      </div>
